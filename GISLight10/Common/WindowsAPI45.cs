...
namespace ESRIJapan.GISLight10.Common
{
    ...
    public static class WindowsAPI45
    {
		...
		internal class PictDesc {
            ...
            /// </summary>
            internal int cbSizeOfStruct = Marshal.SizeOf(typeof(PictDesc));
            /// <summary>
            /// Type of picture described by this structure
            /// </summary>
            internal int picType = (int)PictureTypeConstants.picTypeBitmap;
            /// <summary>
            /// The HBITMAP handle identifying the bitmap assigned to the picture object
            /// </summary>
            internal IntPtr hPic = IntPtr.Zero;
            /// <summary>
			...
			// Constructor
			internal PictDesc(IntPtr BitmapPtr) {
				this.hPic = BitmapPtr;
			}
        }
        ...
        private static extern stdole.IPictureDisp OleCreatePictureIndirect(
            [MarshalAs(UnmanagedType.AsAny)] object pPictDesc,
			ref Guid riid, 
			[MarshalAs(UnmanagedType.Bool)]bool fOwn,
			[MarshalAs(UnmanagedType.Interface)] out stdole.IPictureDisp ppvObj);
        ...
        private static stdole.IPictureDisp CreatePictureFromSymbol(IntPtr hDCOld, ref IntPtr hBmpNew,
        ...
        private static stdole.IPictureDisp CreatePictureFromBitmap(IntPtr hBmpNew) {
            try {
                PictDesc	picDesc = new PictDesc(hBmpNew);
                Guid		iPictureDispGuid = typeof(stdole.IPictureDisp).GUID;

                return OleCreatePictureIndirect(picDesc, ref iPictureDispGuid, true);
            }
            catch (Exception error) {
                throw error;
            }
