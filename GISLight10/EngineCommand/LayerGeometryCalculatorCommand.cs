...
namespace ESRIJapan.GISLight10.EngineCommand
{
    ...
    /// ジオメトリ演算のコマンドクラス
    /// </summary>
    public class LayerGeometryCalculatorCommand : GeometryCalculatorCommand
    {
        /// <summary>
        /// クリック時処理
        /// ジオメトリ演算フォームの表示
        ...
        public override void OnClick()
        {
            ...
            try
            {
                ...
                frm = new Ui.FormGeometryCalculate(m_mapControl,pLayer);
        ...
        public override bool Enabled
        {
            get
            {
                ...
                if (!(pLayer.FeatureClass.ShapeType == ESRI.ArcGIS.Geometry.esriGeometryType.esriGeometryPolygon ||
