...
{
    partial class FormLegendSettings2
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.toolTip1.SetToolTip(this.checkBoxUnderline, "下線");
			...
			this.toolTip1.SetToolTip(this.checkBoxItalic, "斜体");
			...
			this.toolTip1.SetToolTip(this.checkBoxBold, "太字");
